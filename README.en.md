...
<p align="center">
  ...
  ·
  <a href="https://github.com/greeeds/one-api/issues">Feedback</a>
  ·
...
17. Supports user management and multiple user login/registration methods:
    ...
    + WeChat Official Account authorization (requires additional deployment of [WeChat Server](https://github.com/greeeds/wechat-server)).
...
### Manual Deployment
1. Download the executable file from [GitHub Releases](https://github.com/greeeds/one-api/releases/latest) or compile from source:
   ```shell
...
Refer to [#175](https://github.com/greeeds/one-api/issues/175) for detailed instructions.

If you encounter a blank page after deployment, refer to [#97](https://github.com/greeeds/one-api/issues/97) for possible solutions.
