...
<p align="center">
  ...
  <a href="#usage">使用方法</a>
  ·
  <a href="https://github.com/greeeds/one-api/issues">フィードバック</a>
  ·
...
17. ユーザー管理と複数のユーザーログイン/登録方法をサポート:
    ...
    + WeChat 公式アカウントの認証（[WeChat Server](https://github.com/greeeds/wechat-server)の追加導入が必要）。
...
### マニュアルデプロイ
1. [GitHub Releases](https://github.com/greeeds/one-api/releases/latest) から実行ファイルをダウンロードする、もしくはソースからコンパイルする:
   ```shell
...
詳しい手順は [#175](https://github.com/greeeds/one-api/issues/175) を参照してください。

配置後に空白のページが表示される場合は、[#97](https://github.com/greeeds/one-api/issues/97) を参照してください。
